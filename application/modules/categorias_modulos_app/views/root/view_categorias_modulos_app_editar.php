              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Nombre","nombre","nombre","Ingrese el titulo",$detalle->nombre); ?>
                    <?php echo form_error('nombre', '<div class="mensaje_error">', '</div>'); ?>
                    <?php echo textarea ("Descripci&oacute;n","descripcion","descripcion","Ingrese la descripci&oacute;n",$detalle->descripcion); ?>
                    <?php echo form_error('Descripcion', '<div class="mensaje_error">', '</div>'); ?>
                    <?php echo input_text ("Icono","icono","icono","Ingrese el codigo del icono",$detalle->icono); ?>
                    <?php echo form_error('icono', '<div class="mensaje_error">', '</div>'); ?>
                    <?php 

                    ...
                    <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($lista as $key => $value): ?>
                          ...
                          <tr id="<?php echo $value->id_categorias_modulos_app; ?>">
                           <td style="display:none;"><?php echo $value->orden; ?></td>
                           <td style="display:none;"><?php echo $value->id_categorias_modulos_app; ?></td>
                           <td><?php echo $value->nombre; ?></td>
                           <td><?php echo $value->icono; ?></td>
                           <td><?php echo $value->estado_nombre; ?></td>
                           <td> 
                           <a href="<?php echo $this->uri->segment(1); ?>/root/editar/<?php echo $value->id_categorias_modulos_app; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Editar</a> 
                            <a href="#" id="<?php echo $value->id_categorias_modulos_app; ?>" class="btn btn-danger btn-xs lanzar_confirmacion"><i class="fa"></i> Borrar</a> 
                             </td>
                         </tr>
                       <?php endforeach ?>         
                     </tbody>

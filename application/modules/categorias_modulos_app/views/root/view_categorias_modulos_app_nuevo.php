							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre"); ?>
										<?php echo textarea ("Descripci&oacute;n","descripcion","descripcion","Ingrese la descripci&oacute;n"); ?>
										<?php echo form_error('descripcion', '<div class="mensaje_error">', '</div>'); ?>
									   <?php echo input_text ("Icono","icono","icono","Ingrese el codigo para el icono"); ?>

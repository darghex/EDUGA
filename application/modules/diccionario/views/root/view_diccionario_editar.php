                ...
                <div class="widget">
                  ...
                  <div class="widget-content">
                    <div class="padd">
                      ...
                      <?php echo input_text ("Singular","singular","singular","Ingrese la frase del diccionario en singular",$detalle->singular); ?>
                      <?php echo form_error('singular', '<div class="mensaje_error">', '</div>'); ?>
                      <?php echo input_text ("Plural","plural","plural","Ingrese la frase del diccionario en plural",$detalle->plural); ?>
                      <?php echo form_error('plural', '<div class="mensaje_error">', '</div>'); ?>
                      <?php echo input_text ("Llave","llave","llave","Ingrese la llave del diccionario",$detalle->llave); ?>

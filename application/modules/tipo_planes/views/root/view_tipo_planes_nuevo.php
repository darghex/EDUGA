              ...
              <div class="widget">
                <div class="widget-head">
                  ...
                  <div class="widget-icons pull-right">
                    <a href="#" class="wminimize"><i class="fa fa-chevron-uap"></i></a> 
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre del plan",$this->input->post('nombre'),form_error('nombre', '<div class="mensaje_error">', '</div>')); ?>
                    <?php echo textarea ("Descripción","Descripcion","Descripcion","Ingrese la Descripcion del plan",$this->input->post('Descripcion'),form_error('Descripcion', '<div class="mensaje_error">', '</div>')); ?>
                    <?php 

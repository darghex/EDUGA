...
class Root extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->variables=array('modulo'=>'notificaciones','id'=>'id_notificaciones','modelo'=>'model_notificaciones');
	...
	public function lista()
	{
		...
		$miscursos_doc_tmp=$this->model_notificaciones->cursos_list_doc($id_usuarios);
		...
		$data['lista']=$this->model_notificaciones->listado($variables['modulo'],'',array('orden','asc'),$miscursos_doc);
		/* Envio header de la tabla de los campos que necesito mostrar */
		$data['titulos']=array("Orden","ID","Usuario","Curso","Mensaje","Estado","Opciones");
	...
	public function nuevo()
	{
		...
		$miscursos_doc=$this->model_notificaciones->cursos_list_doc($id_usuarios);
...
// funcion para validar datos en cascada
	...
	function get_estudiantes_curso ($id_cursos) {
		$this->load->model('model_notificaciones');
		$estudiantes_lista=$this->model_notificaciones->get_estudiantes_curso($id_cursos);
		$html="";

		foreach ($estudiantes_lista as $key => $value) {
			$html.='<label class="checkbox-inline"><input type="checkbox" name="usuarios[]" value="'.$value->id_usuarios.'" />'.$value->nombres.' '.$value->apellidos.'</label>';
		}
		echo $html;

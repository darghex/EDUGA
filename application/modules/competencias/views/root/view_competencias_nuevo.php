							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre de la competencia",$this->input->post('nombre'),form_error('nombre', '<div class="mensaje_error">', '</div>')); ?>
										<?php echo textarea ("Descripci&oacute;n","descripcion","descripcion","Ingrese la Descripci&oacute;n de la competencia",$this->input->post('descripcion'),form_error('descripcion', '<div class="mensaje_error">', '</div>')); ?>
										<?php 

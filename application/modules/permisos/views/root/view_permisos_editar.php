            ...
            <div class="widget">
              ...
              <div class="widget-content">
                <div class="padd">
                  ...
                  echo select ("Modulos","id_modulos_app","id_modulos_app",$opciones,$detalle->id_modulos_app); 
                  ?>
                  <?php 
                  $array_opc=array();
                  #echo $detalle->id_roles;
              #    if (@in_array("listar", json_decode($detalle->permisos) )) { $array_opc["permisos[]|listar|listar|checked"]="listar"; }
               #   else { $array_opc["permisos[]|listar|listar"]="listar"; }
                  
                  foreach ($lista_roles as $key => $value) {
                   if (@in_array($value->id_roles, json_decode($detalle->id_roles) )) {
                    $array_opc["id_roles[]|id_roles[]|".$value->id_roles."|checked|checked".$value->id_roles.""]=$value->nombre;
                  } else {

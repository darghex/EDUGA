   ...
   <div class="mainbar">
    <div class="page-head">
      ...
      <div class="bread-crumb pull-right">
       ...
       <a href="<?php echo base_url(); ?><?php echo $this->uri->segment(1); ?>/<?php echo $this->uri->segment(2); ?>/lista_estudiantes/<?php echo $this->uri->segment(4); ?>" class="bread-current">Lista de estudiantes</a>      </div>
                      ...
                      <tbody>
                        ...
                        <?php foreach ($lista as $key => $value): ?>
                          ...
                          <tr id="<?php echo $value->id_cursos_asignados; ?>">
                           ...
                           <td><?php echo $value->id_actividades_evaluacion; ?></td>
                           <?php */ ?>
                          ...
                          <?php /* ?>
                           ...
                           <td> 
                             ...
                             <?php if (if_calificar($value->id_usuarios,$value->id_cursos,$value->id_actividades_barra,$value->id_actividades)<1): ?>
                              <a href="<?php echo $this->uri->segment(1); ?>/root/calificar/<?php echo $this->uri->segment(4); ?>/<?php echo $value->id_usuarios; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Calificar</a> 
                            <?php else: ?>
                              <a  class="btn btn-default btn-xs"><i class="fa"></i> Calificado</a> 
                            <?php endif ?>

...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			...
			<div class="page-head">
				<h2 class="pull-left"><i class="fa fa-table"></i> Modulo <?php echo asignar_frase_diccionario ($diccionario,'{landings}',$titulo,1); ?> (Nuevo registro)</h2>
							...
							<div class="widget">
								...
								<div class="widget-content"> 
									<div class="padd">
										...
										<?php echo input_text ("Título","titulo","titulo","Ingrese el título",$this->input->post('titulo'),form_error('titulo', '<div class="mensaje_error">', '</div>')); ?>
										<?php echo textarea ("Descripci&oacute;n","descripcion","descripcion","Ingrese la descripci&oacute;n",$this->input->post('descripcion'),form_error('descripcion', '<div class="mensaje_error">', '</div>')); ?>
									...
									<?php echo input_text ("Url video youtube","url_video","url_video","Ingrese la url video youtube",$this->input->post('url_video'),form_error('url_videos', '<div class="mensaje_error">', '</div>')); ?>

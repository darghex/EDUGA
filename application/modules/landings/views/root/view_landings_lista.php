...
<body>
  ...
  <div class="content">
   ...
   <div class="mainbar">
    <div class="page-head">
      <h2 class="pull-left"><i class="fa fa-table"></i> Listado de <?php echo asignar_frase_diccionario ($diccionario,'{landings}',$titulo,2); ?></h2>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                    ...
                    <tbody>
                      ...
                      <?php foreach ($lista as $key => $value): ?>
                        ...
                        <tr id="<?php echo $value->id_landings; ?>">
                         <td><?php echo $value->orden; ?></td>
                         <td><?php echo $value->id_landings; ?></td>
                         <td><?php echo $value->titulo; ?></td>
                         
                         <td><?php echo $value->descripcion; ?></td>


                  <td> <a target="_blank" href="<?php echo base_url(); ?>plataforma/estudio-virtual/<?php echo $value->id_landings; ?>/<?php echo amigable($value->titulo); ?>.html"> <?php echo base_url(); ?>plataforma/estudio-virtual/<?php echo $value->id_landings; ?>/<?php echo amigable($value->titulo); ?>.html </a> </td>

                         <td><?php echo $value->estado_nombre; ?></td>
                         <td>  
                           <a href="<?php echo $this->uri->segment(1); ?>/root/editar/<?php echo $value->id_landings; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Editar</a> 
                           <a href="#" id="<?php echo $value->id_landings; ?>" class="btn btn-danger btn-xs lanzar_confirmacion"><i class="fa"></i> Borrar</a>
                         </td>
                       </tr>

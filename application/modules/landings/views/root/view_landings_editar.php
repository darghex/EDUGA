...
<body>
  ...
  <div class="content">
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-table"></i>Modulo <?php echo asignar_frase_diccionario ($diccionario,'{landings}',$titulo,1); ?> (Editar registro)</h2>
            ...
            <div class="col-md-12">
              <div class="widget">
                ...
                <div class="widget-content">
                 ...
                 <?php echo input_text ("Url video youtube","url_video","url_video","Ingrese la url video youtube",$detalle->url_video,form_error('url_videos', '<div class="mensaje_error">', '</div>')); ?>

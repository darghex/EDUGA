              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo textarea ("Resumen de perfil","resumen_de_perfil","resumen_de_perfil","Ingrese un resumen de perfil",$this->input->post('resumen_de_perfil'),form_error('resumen_de_perfil', '<div class="mensaje_error">', '</div>')); ?>
                    <div id="contador"></div>
                    <?php 

                ...
                <div class="widget">
                  ...
                  <div class="widget-content">
                    <div class="padd">
                      ...
                      echo select ("Categoria Módulo","id_categorias_modulos_app","id_categorias_modulos_app",$opciones,$detalle->id_categorias_modulos_app); 
                      ?>


                      <?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre",$detalle->nombre); ?>
                      <?php echo form_error('nombre', '<div class="mensaje_error">', '</div>'); ?>

                      <?php echo input_text ("Llave","llave","llave","Ingrese la llave del diccionario  (No es obligatorio, ver modulo diccionario)",$detalle->llave); ?>
                      <?php echo form_error('llave', '<div class="mensaje_error">', '</div>'); ?>

                      <?php echo textarea ("Descripción","descripcion","descripcion","Ingrese la descripción",$detalle->descripcion,form_error('descripcion', '<div class="mensaje_error">', '</div>')); ?>

                      <?php echo input_text ("Carpeta","carpeta","carpeta","Ingrese el nombre de la carpeta",$detalle->carpeta); ?>

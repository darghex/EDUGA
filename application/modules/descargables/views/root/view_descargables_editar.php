              ...
              <div class="widget-content">
                <div class="padd">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-5">
                      <input type="hidden" name="image" id="image" value="<?php echo $detalle->archivo; ?>">
                      <div class="fileupload <?php if ($detalle->archivo): ?> fileupload-exists <?php else : ?> fileupload-new <?php endif ?>" data-provides="fileupload">
                        <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                          <img src="http://www.placehold.it/200x150/EFEFEF/AAAAAA" alt="img"/>
                        </div>
                        <div id="cambis" class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">            




                          <img src="<?php echo set_icon_archivo (base_url().'uploads/'.$titulo.'/'.$detalle->archivo); ?>
                        ...
                        <div>
                          <span class="btn btn-file">
                            ...
                            <input type="file" value="<?php echo base_url().'uploads/'.$titulo.'/'.$detalle->archivo; ?>" name="userfile" id="userfile"/>
                          </span>

              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre del estatus",$detalle->nombre,form_error('nombre', '<div class="mensaje_error">', '</div>')); ?>
                    <?php echo textarea ("Descripción","Descripcion","Descripcion","Ingrese la descripción del estatus",$detalle->Descripcion,form_error('Descripcion', '<div class="mensaje_error">', '</div>')); ?>
                    <?php 

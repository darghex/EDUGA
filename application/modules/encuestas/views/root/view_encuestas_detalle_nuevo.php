...
<head>
	...
	<meta charset="utf-8">
	<title>Modulo <?php echo str_replace("_", " ", $titulo); ?> (Preguntas) (Nuevo registro) - Administrador</title>
...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left"><i class="fa fa-table"></i>Modulo <?php echo str_replace("_", " ", $titulo); ?> (Preguntas) (Nuevo registro)</h2>
								...
								<div class="widget">
									...
									<div class="widget-content">
										<div class="padd">
											...
											<?php echo input_text ("Pregunta","nombre","nombre","Ingrese el nombre de la encuesta como referencia",$this->input->post('nombre'),form_error('nombre', '<div class="mensaje_error">', '</div>')); ?>

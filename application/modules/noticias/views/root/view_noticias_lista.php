                      ...
                      <table cellpadding="0" cellspacing="0" border="0" id="data-table" width="100%">
                        ...
                        <tbody>
                          ...
                          <?php foreach ($lista as $key => $value): ?>
                            ...
                            <tr id="<?php echo $value->id_noticias; ?>">
                             <td><?php echo $value->orden; ?></td>
                             <td><?php echo $value->id_noticias; ?></td>
                             <td><?php echo $value->titulo; ?></td>
                             <td><?php echo $value->Descripcion; ?></td>
                             <td><?php echo $value->estado_nombre; ?></td>
                             <td>  <a href="<?php echo $this->uri->segment(1); ?>/root/editar/<?php echo $value->id_noticias; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Editar</a> <a href="#" id="<?php echo $value->id_noticias; ?>" class="btn btn-danger btn-xs lanzar_confirmacion"><i class="fa"></i> Borrar</a> </td>
                           </tr>

...
<body>
  ...
  <div class="content">
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <h2 class="pull-left"><i class="fa fa-table"></i> Listado de <?php echo $titulo; ?> (Editar registro)</h2>
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  <div class="padd">
                    ...
                    <?php echo input_text ("Titulo","titulo","titulo","Ingrese el titulo de la noticia",$detalle->titulo,form_error('titulo', '<div class="mensaje_error">', '</div>') ); ?>
                    <?php echo textarea ("Descripción","Descripcion","Descripcion","Ingrese la Descripcion de la noticia",$detalle->Descripcion,form_error('Descripcion', '<div class="mensaje_error">', '</div>')); ?>
                      ...
                      <div class="col-lg-5">
                       ...
                       <div class="fileupload <?php if ($detalle->foto): ?> fileupload-exists <?php else : ?> fileupload-new <?php endif ?>" data-provides="fileupload">
                        ...
                        <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;">            
                          <img src="<?php echo base_url().'uploads/noticias/'.$detalle->foto; ?>" alt="img"/>
                        </div>
                  ...
                  <?php echo editor ("Contenido","contenido","contenido",$detalle->contenido,form_error('contenido', '<div class="mensaje_error">', '</div>')) ?>
                  <?php 

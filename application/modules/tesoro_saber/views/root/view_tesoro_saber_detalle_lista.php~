     ...
     <div class="matter">
      <div class="container">
        <div class="row">
         ...
         <?php endif ?>
         <div class="col-md-12">
          <a href="<?php echo $this->uri->segment(1); ?>/root/nueva_pregunta/<?php echo $this->uri->segment(4) ?>" class="btn btn-success btn-xs"><i class="fa"></i> Nuevo</a>
          <div class="widget">
            ...
            <div class="widget-content">
              <div class="padd">
			   ...
			   <td><?php echo $value->rc ?></td>
                            <td><?php echo $value->estado_nombre; ?></td>
                           <td> 
                           <a orden="<?php echo $value->orden; ?>" href="<?php echo $this->uri->segment(1); ?>/root/editar_pregunta/<?php echo $this->uri->segment(4); ?>/<?php echo $value->id; ?>" class="btn btn-info btn-xs"><i class="fa"></i> Editar</a> 

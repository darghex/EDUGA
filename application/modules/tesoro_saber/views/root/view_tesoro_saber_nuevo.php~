...
<head>
	...
	<meta charset="utf-8">
	<title>Módulo banco de preguntas tesoro del saber (Nuevo registro) - Administrador</title>
...
<body>
	...
	<div class="content">
		...
		<div class="mainbar">
			<div class="page-head">
				<h2 class="pull-left"><i class="fa fa-table"></i>Módulo <?php echo str_replace("_", " ", $titulo); ?>  (Nuevo registro)</h2>
							...
							<div class="widget">
								...
								<div class="widget-content">
									<div class="padd">
										...
										<?php echo input_text ("Nombre","nombre","nombre","Ingrese el nombre de la categoría de preguntas como referencia"); ?>
										<?php echo textarea ("Descripci&oacute;n","descripcion","descripcion","Ingrese la descripción de la categoría"); ?>
